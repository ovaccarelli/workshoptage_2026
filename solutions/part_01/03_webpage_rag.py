...
# Limit chunks to 2,000 characters and retain 400 characters of context between
# consecutive chunks.
CHUNK_SIZE = 2000
CHUNK_OVERLAP = 400
...
def build_chunks(text: str) -> list[str]:
    ...
    # SOLUTION - Split by Markdown headings:
    ...
    # SOLUTION - Split large sections recursively:
...
def create_vector_collection(chunks: list[str]) -> chromadb.Collection:
    ...
    # Recreate this workshop-owned collection so old IDs and removed chunks do
    # not survive between runs and consume retrieval slots.
    try:
...
# SOLUTION - Build the vector collection:
...
# SOLUTION - Configure retrieval:
# Return at most five relevant chunks for each question.
TOP_K = 5
...
def retrieve_context(
    ...
    """
    # SOLUTION - Retrieve the most relevant chunks:
...
# SOLUTION - Generate a grounded answer:
