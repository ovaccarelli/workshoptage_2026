...
# SOLUTION - OCR engine:
# Set RapidOCR to error-only logging so model-loading information is not printed.
...
# SOLUTION - Webpage extraction:
# Fetch the webpage, convert it to Markdown, and save it locally.
